            ...
            <nav style="background-color: #f5f5f5" class="navbar navbar-light navbar-expand fixed-bottom">
                <div class="collapse navbar-collapse" id="navcol-1" style="height: 80px">
                    <ul class="nav navbar-nav mx-auto">
                        ...
                        <li class="nav-item animated fadeInLeftBig" role="presentation"><a id="btnUpload" class="nav-link" onclick="uploadImagem()"><i class="fa fa-cloud-upload-alt menu"></i></a></li>
                    </ul>
                </div>
            </nav>
        </form>
